    ...
    <main className="min-h-screen flex items-center justify-center px-6" style={{ background: "#08070a" }}>
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl p-8"
          ...
          <h1 className="text-white font-bold text-xl mb-1 tracking-tight">Вход</h1>
          <p className="text-[13px] mb-7" style={{ color: "rgba(255,255,255,0.3)" }}>Войдите в свой аккаунт</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button type="submit" disabled={loading}
              className="h-11 rounded-xl text-[11px] font-black tracking-[0.2em] uppercase hover:opacity-80 disabled:opacity-40 mt-1"
          ...
          <p className="mt-6 text-center text-[12px]" style={{ color: "rgba(255,255,255,0.25)" }}>
            Нет аккаунта?{" "}
            <Link href="/auth/register" className="hover:opacity-70 transition-opacity" style={{ color: GOLD_DIM }}>
              Зарегистрироваться
            </Link>
          </p>
        </div>
